...
<body class="bg-[#fff] text-white">
    ...
    <footer class="bg-[#55AE50] p-4">
        ...
        <div class="text-center mt-4">
            <p class="text-sm text-gray-800 roboto-bold">&copy; {{ date('Y') }} Agroinsumos y Servicios ROA FP. Todos los derechos reservados.</p>
        </div>
    </footer>
